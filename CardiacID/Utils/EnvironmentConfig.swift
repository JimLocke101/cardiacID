...
struct EnvironmentConfig {
    ...
    private init() {
        ...
        // API Configuration
        self.supabaseURL = bundle.object(forInfoDictionaryKey: "HEARTID_SUPABASE_URL") as? String ?? ""
        self.supabaseProjectID = bundle.object(forInfoDictionaryKey: "HEARTID_SUPABASE_PROJECT_ID") as? String ?? ""
